...
pip install boto3 botocore jmespath ansible paramiko pyyaml ansible-lint molecule molecule-docker yamllint requests docker kubernetes passlib netaddr dnspython cryptography
check_command
echo ""
